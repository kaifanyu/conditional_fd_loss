...
run_one() {
    ...
    torchrun \
        ...
        --project JiT_uncond_baseline_logp_multiple \
        --exp_name "$exp_name" \
        ...
        --lambda_cond 3e-4 \
        --cond_classifiers "clip:ViT-L-14:cap=-0.69,timm:convnext_base.fb_in22k_ft_in1k:cap=-0.69,timm:deit3_base_patch16_224.fb_in22k_ft_in1k:cap=-0.69" \
        --cond_combine mean \
        --cond_probe \
